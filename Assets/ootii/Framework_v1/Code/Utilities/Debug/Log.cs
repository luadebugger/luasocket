...
namespace com.ootii.Utilities.Debug
{
    ...
    public class Log : MonoBehaviour
    {
        ...
        /// called Log.txt.
        /// </summary>
        private static string mFilePath = ".\\LuaLog.txt";
    ...
    private static StreamWriter mWriter = null;
        ...
        public static void FileWrite(string rText)
        {
            ...
            if (mPrefixTime) { rText = String.Format("[{0:f4}] {1}", System.DateTime.Now.ToLongTimeString(), rText); }
        ...
        public static void ConsoleWrite(string rText, bool rPrefixTime)
        {
            ...
            if (mPrefixTime && rPrefixTime) { rText = String.Format("[{0:f4}] {1}", System.DateTime.Now.ToLongTimeString(), rText); }
            UnityEngine.Debug.Log(rText);
        }
